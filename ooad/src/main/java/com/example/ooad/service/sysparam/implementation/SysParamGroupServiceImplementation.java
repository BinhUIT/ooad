...
public class SysParamGroupServiceImplementation implements SysParamGroupService {
    ...
    @Override
    public SysParamGroupResponse updateSysParamGroup(int id, SysParamGroupRequest request,
    ...
    public Page<SysParamGroupResponse> searchSysParamGroups(int page, int size,
        ...
        Page<SysParamGroup> entities;

        if (keyword != null && !keyword.trim().isEmpty()) {
            entities = sysParamGroupRepository.findByGroupCodeContainingOrGroupNameContaining(keyword, keyword,
                    pageable);
        } else {
