...
public class SysParamGroupController {
   ...
   @PostMapping
   public ResponseEntity<?> createSysParamGroup(@Valid @RequestBody SysParamGroupRequest request,
         BindingResult bindingResult) {
      SysParamGroupResponse response = sysParamGroupService.createSysParamGroup(request, bindingResult);
   ...
   @PutMapping("/{id}")
   public ResponseEntity<?> updateSysParamGroup(@PathVariable int id, @Valid @RequestBody SysParamGroupRequest request,
         BindingResult bindingResult) {
      SysParamGroupResponse response = sysParamGroupService.updateSysParamGroup(id, request, bindingResult);
   ...
   public ResponseEntity<?> getSysParamGroupById(@PathVariable int id) {
      SysParamGroupResponse response = sysParamGroupService.getSysParamGroupById(id);
      return ResponseEntity.ok(response);
   }
   ...
   public ResponseEntity<?> getSysParamGroupByCode(@PathVariable String groupCode) {
   ...
   public ResponseEntity<?> searchSysParamGroups(
      ...
      var response = sysParamGroupService.searchSysParamGroups(page, size, keyword);
      return ResponseEntity.ok(response);
   }
