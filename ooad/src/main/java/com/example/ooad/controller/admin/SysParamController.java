...
public class SysParamController {
   ...
   @PostMapping
   public ResponseEntity<?> createSysParam(@Valid @RequestBody SysParamRequest request, BindingResult bindingResult) {
   ...
   @PutMapping("/{id}")
   public ResponseEntity<?> updateSysParam(@PathVariable int id, @Valid @RequestBody SysParamRequest request,
         BindingResult bindingResult) {
      SysParamResponse response = sysParamService.updateSysParam(id, request, bindingResult);
   ...
   public ResponseEntity<?> getSysParamsByGroupId(@PathVariable int groupId) {
      List<SysParamResponse> response = sysParamService.getSysParamsByGroupId(groupId);
      return ResponseEntity.ok(response);
   }
   ...
   public ResponseEntity<?> getSysParamsByGroupCode(@PathVariable String groupCode) {
      List<SysParamResponse> response = sysParamService.getSysParamsByGroupCode(groupCode);
      return ResponseEntity.ok(response);
   }
   ...
   public ResponseEntity<?> searchSysParams(
      ...
      var response = sysParamService.searchSysParams(page, size, keyword, groupId);
      return ResponseEntity.ok(response);
   }
